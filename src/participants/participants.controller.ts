...
export class ParticipantsController {
    ...
    @Post()
    async create(@Body() object: CreateParticipantDto,): Promise<ParticipantsEntity> {
        try {
    ...
    @Get()
    async findAll(@Query() options: FindOptionsDto<ParticipantsEntity>): Promise<FindReturnModelDto<ParticipantsEntity>> {
        try {
