...
export const isAfter = (
  ...
  if (!startOf) return moment(start).isAfter(moment(end));
    ...
    return moment(start).startOf(startOf).isAfter(moment(end).startOf(startOf));
};
...
export const isBefore = (
  ...
  if (!startOf) return moment(start).isBefore(moment(end));
    ...
    return moment(start)
      .startOf(startOf)
      .isBefore(moment(end).startOf(startOf));
};

export const validateDaysComplete = (
  betDays: Array<BetDaysEntity>,
  today: moment.Moment,
) => {
